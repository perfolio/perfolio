...
var writeMigrations = function (atChildDbPath, migrations, time) {
    if (atChildDbPath === void 0) { atChildDbPath = []; }
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            files_1.writeNewMigration(atChildDbPath, migrations, time);
            return [2 /*return*/];
        });
    });
};
exports.writeMigrations = writeMigrations;
var generateMigrations = function (planned) {
    var migrExprs = [];
    ...
    migrExprs.push(transformStatements(planned[resource_types_1.ResourceTypes.Database]));
    var migrExprsFlat = [].concat.apply([], migrExprs);
