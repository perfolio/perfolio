...
export declare const generateRollbackQuery: (expressions: TaggedExpression[], skippedMigrations: string[], currentMigration: string, migrCollection: string) => fauna.Expr;
