...
var rollback = function (amount, atChildDbPath) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var client, query, cloudMigrations, allCloudMigrations, rMigs, diff, expressions, migrCollection, error_1, missingMigrDescription, schemaDescription;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    if (!(allCloudMigrations.length === 0)) return [3 /*break*/, 5];
                    interactive_shell_1.interactiveShell.completeSubtask("Done, no migrations to rollback");
                    return [3 /*break*/, 14];
                case 5:
                    if (!(amount >= allCloudMigrations.length && process.env.FAUNA_CHILD_DB)) return [3 /*break*/, 9];
                ...
                case 11:
                    ...
                    return [4 /*yield*/, rollback_1.generateRollbackQuery(expressions, rMigs.toRollback.skipped.map(function (e) { return e.timestamp; }), rMigs.toRollback.current.timestamp, migrCollection)];
                case 12:
                    query = _a.sent();
