    ...
    <section className="bg-white ">
      <div className="h-screen mx-auto max-w-7xl">
        ...
        <div className="flex flex-col items-center justify-center h-full space-y-10 md:space-y-0 md:flex-row">
          <div className="w-full md:w-1/2 md:h-full md:bg-gradient-to-r md:from-white md:via-white md:to-gray-100">
          ...
          <div className="flex items-center justify-center space-y-16 md:w-1/2">{children}</div>
        </div>
      </div>
    </section>
  )
