        ...
        <div className="container mx-auto ">
          <div className="xl:flex">
            <div className="-mt-8 xl:w-3/4 2xl:w-4/5 xl:-mt-64">
              <div className="py-4 bg-gray-100 rounded-t shadow dark:text-gray-50 dark:bg-gray-700 md:pl-10 md:py-7">
                <p className="text-base font-bold leading-normal text-gray-800 dark:text-gray-100 sm:text-lg md:text-xl lg:text-2xl">
                  {title}
                </p>
              </div>
              <div className="p-4 bg-white divide-y divide-gray-300 shadow-lg dark:divide-gray-700 md:px-8 xl:px-10 dark:bg-gray-900">
                {children}
              </div>
            </div>
