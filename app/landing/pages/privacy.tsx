    ...
    <div>
      <div className="pt-16 -mt-16 bg-gray-50 ">
        ...
        <Section className="mx-auto prose-sm prose sm:prose lg:prose-lg xl:prose-xl">
          ...
          <p>
            <strong>Vertretungsberechtigte Personen:</strong> Nicolas
            Webersinke, Andreas Thomas, Mads Jordt, Kevin Kohler
          </p>
          <p>
          ...
          <p>
            ...
            den Betrieb unseres Onlineangebotes unbedingt erforderlich sind.
          </p>
          <ul>
            <li>
          ...
          <p>
            ...
            Datei, die beim Öffnen des Newsletters von unserem Server, bzw.,
