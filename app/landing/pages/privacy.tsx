  ...
  return (
    ...
    <div className="pt-16 -mt-16 bg-gray-50 ">
      ...
      <Section className="mx-auto prose-sm prose sm:prose lg:prose-lg xl:prose-xl">
        ...
        <p>
          <strong>Vertretungsberechtigte Personen:</strong> Nicolas Webersinke,
          Andreas Thomas, Mads Jordt, Kevin Kohler
        </p>
        <p>
          <strong>E-Mail-Adresse:</strong>{" "}
          <a href="mailto:info@perfol.io">info@perfol.io</a>
        </p>
        <p>
        ...
        <p>
          ...
          erforderlich ist, werden Vertragspartner hierauf ebenso hingewiesen
        ...
        <ul>
          <li>
            ...
            (z.B. Texteingaben, Fotografien, Videos), Meta-/Kommunikationsdaten
        ...
        <p>
          ...
          bitten, ist diese Rechtsgrundlage der Verarbeitung, ansonsten erfolgt
          die Verarbeitung der Daten der Teilnehmer auf Grundlage unserer
        ...
        <ul>
          ...
          <li>
            ...
            Tracking (z.B. interessens-/verhaltensbezogenes Profiling, Nutzung
            von Cookies), Feedback (z.B. Sammeln von Feedback via
            Online-Formular).
          </li>
          <li>
            <strong>Rechtsgrundlagen:</strong> Einwilligung (Art. 6 Abs. 1 S. 1
