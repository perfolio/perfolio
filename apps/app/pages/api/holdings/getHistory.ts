...
export const GetHistoryRequestValidation = z.any()
...
async function getHistory(_: void, claims: Claims) {
  let transactions = await getTransactions(_, claims)
...
export default withMiddleware(getHistory, GetHistoryRequestValidation)
