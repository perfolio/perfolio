    ...
    return (
        <>
            <div className="hidden md:flex">
                <DesktopAssetTable aggregation={aggregation} setAggregation={setAggregation} costPerShare={costPerShare} totalValue={totalValue} ranges={ranges} range={range} setRange={setRange} ></DesktopAssetTable>
            </div>
            <div className="flex md:hidden">
                <MobileAssetTable aggregation={aggregation} setAggregation={setAggregation} costPerShare={costPerShare} totalValue={totalValue} ranges={ranges} range={range} setRange={setRange}></MobileAssetTable>
            </div>
        </>
    )
}
