    ...
    return (
        <>
            <div className="hidden md:flex">
                <DesktopAssetTable aggregation={aggregation} setAggregation={setAggregation} costPerShare={costPerShare} totalValue={totalValue} ></DesktopAssetTable>
            </div>
            <div className="flex md:hidden">
                <MobileAssetTable aggregation={aggregation} setAggregation={setAggregation} costPerShare={costPerShare} totalValue={totalValue} ></MobileAssetTable>
            </div>
        </>
    )
}
