...
CREATE TABLE "VerificationRequest" (
    ...
    "payedUntil" INTEGER NOT NULL DEFAULT 0,
    "plan" "Plan" NOT NULL DEFAULT E'TRIAL',
...
-- CreateIndex
CREATE UNIQUE INDEX "VerificationRequest.stripeCustomerId_unique" ON "VerificationRequest"("stripeCustomerId");
