...
const colors = (kind: Kind, disabled?: boolean): string => {
  ...
  const options: Record<Kind, string> = {
    ...
    cta:
      'from-orange-600 to-yellow-500 text-white justify-center w-full text-sm text-center rounded bg-gradient-to-tr sm:text-base md:text-lg hover:from-orange-600 hover:to-yellow-300 duration-200 hover:text-black',
    plain:
